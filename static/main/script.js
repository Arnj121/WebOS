        ...
        xhr.onreadystatechange = function (){
            if(xhr.readyState == 4){
                ...
                if(appmanager.Apps[appId].sys) {
                    style.href = `http://54.90.104.210:2000/apps/sys/${appId}/${appId}.css`
                    script.src = `http://54.90.104.210:2000/apps/sys/${appId}/${appId}.js`
                }
                else {
                    style.href = `http://54.90.104.210:2000/apps/custom/${appId}/${appId}.css`
                    script.src = `http://54.90.104.210:2000/apps/custom/${appId}/${appId}.js`
                }
...
class AppManager{
    Apps={
        njk2d4kd:{
            code:'http://54.90.104.210:2000/apps/sys/njk2d4kd/njk2d4kd.html',
            iconTpe:'fa',
            iconSrc:'fal fa-cog',
            appname:'Settings',
            sys:1,
        ...
        df3mk3lm:{
            code:'http://54.90.104.210:2000/apps/sys/df3mk3lm/df3mk3lm.html',
            iconTpe: 'fa',
        ...
        dfo3imf3:{
            code:'http://54.90.104.210:2000/apps/sys/dfo3imf3/dfo3imf3.html',
            iconTpe:'fa',
        ...
        njk39c3ce: {
            code: 'http://54.90.104.210:2000/apps/sys/njk39c3ce/njk39c3ce.html',
            iconTpe: 'fa',
        ...
        xo23qwrr: {
            code: 'http://54.90.104.210:2000/apps/sys/xo23qwrr/xo23qwrr.html',
            iconTpe: 'fa',
        ...
        oermfo3f:{
            code: 'http://54.90.104.210:2000/apps/sys/oermfo3f/oermfo3f.html',
            iconTpe: 'fa',
        ...
        cal2f4f43:{
            code: 'http://54.90.104.210:2000/apps/sys/cal2f4f43/cal2f4f43.html',
            iconTpe: 'fa',
        ...
        fil23ex45:{
            code: 'http://54.90.104.210:2000/apps/sys/fil23ex45/fil23ex45.html',
            iconTpe: 'fa',
        ...
        ter243min: {
            code: 'http://54.90.104.210:2000/apps/sys/ter243min/ter243min.html',
            iconTpe: 'fa',
    ...
    loadApps(){
        ...
        xhr.open('GET','http://54.90.104.210:2000/loadapps?email='+user.getEmail())
        xhr.send()
    }
...
class CommandLine{
    ...
    history=[]
    packagesAvailable={}
    cmdLibLoc='http://54.90.104.210:2000/apps/sys/ter243min/cmdlibs/'
    ...
    LoadCmdFiles(file=0,type=0,id=0){
        if (file!=0){
            let script = document.createElement('script')
            script.src = `http://54.90.104.210:2000/userfiles/${type}/${id}/home/bin/${file}.js`
...
class System{
    ...
    settings= {
        ...
        background: {
            ...
            backgroundurl: 'http://54.90.104.210:2000/main/default.png',
        },
        appdrawer: {
            onlyhome: 0,
            icons: {
    ...
    addaccount(appId,userdetail){
        if(appmanager.Apps[appId].permission.modify) {
            ...
            xhr.open('POST', 'http://54.90.104.210:2000/signup')
    ...
    login(email,password){
        ...
        xhr.open('POST','http://54.90.104.210:2000/login')
        xhr.setRequestHeader('Content-Type','application/json;charset=UTF-8')
...
class DataManager{
    ...
    initApps(){
        ...
        xhr.open('POST','http://54.90.104.210:2000/initapp')
        xhr.setRequestHeader('Content-Type','application/json;charset=UTF-8')
    ...
    saveapp(app){
        ...
        xhr.open('POST','http://54.90.104.210:2000/saveapp')
        xhr.setRequestHeader('Content-Type','application/json;charset=UTF-8')
    ...
    save(appId,data){
        ...
        if(this.haswriteAccess(appId) && user.getEmail()!=0) {
            ...
            xhr.open('POST', 'http://54.90.104.210:2000/savedata')
            xhr.setRequestHeader('Content-Type', 'application/json;charset=UTF-8')
    ...
    load(appId,callback){
        if(this.hasreadAccess(appId) && user.getEmail()!=0) {
            ...
            xhr.open('GET', `http://54.90.104.210:2000/loaddata?appId=${appId}&email=${user.getEmail()}`)
            xhr.send()
        }
        else{
            if(callback) callback(false)
...
class FileManager{
    ...
    initDir(id){
        fetch(`http://54.90.104.210:2002/initdir?id=${id}`,{method:"GET"})
    }
    ...
    async getChildren(path){
        ...
        await fetch(`http://54.90.104.210:2002/getchildren?uniqueId=${id}&path=${path}&userguest=${userOrGuest}`,{method:'GET'})
            .then(res=>res.json())
            .then((res)=>{r=res})
        return r;
    }
    ...
    //     let r;
    //     await fetch(`http://54.90.104.210:2002/getparent?email=${user.getEmail()}&name=${child}`,{method:'GET'})
    //         .then(res=>res.json())
    //         .then((res)=>{r=res})
    //     return r;
    // }
    async details(path){
        ...
        let userOrGuest = user.IsloggedIn()?'users' : 'guest'
        let id = user.IsloggedIn()?user.getUniqueId() : user.guestId
        await fetch(`http://54.90.104.210:2002/getdetails?userguest=${userOrGuest}&path=${path}&uniqueId=${id}`,{method:'GET'})
            .then(res=>res.json())
            .then((res)=>{r=res})
        return r;
    }
    async root(){
        ...
        let userOrGuest = user.IsloggedIn()?'users' : 'guest'
        let id = user.IsloggedIn()?user.getUniqueId() : user.guestId
        await fetch(`http://54.90.104.210:2002/root?userguest=${userOrGuest}uniqueId=${id}`)
            .then(res=>res.json())
            .then((res)=>{r=res})
        return r
    }
    async createFolder(path,name){
        ...
        let userOrGuest = user.IsloggedIn()?'users' : 'guest'
        let id = user.IsloggedIn()?user.getUniqueId() : user.guestId
        await fetch(`http://54.90.104.210:2002/createfolder?userguest=${userOrGuest}&uniqueId=${id}&path=${path}&name=${name}`,{method:'post'})
            .then(res=>res.json())
            .then((res)=>{r=res})
        return r;
    }
    async createFile(path,name){
        ...
        let userOrGuest = user.IsloggedIn()?'users' : 'guest'
        let id = user.IsloggedIn()?user.getUniqueId() : user.guestId
        await fetch(`http://54.90.104.210:2002/createfile?userguest=${userOrGuest}&uniqueId=${id}&path=${path}&name=${name}`,{method:'GET'})
            .then(res=>res.json())
            .then((res)=>{r=res})
        return r;
    }
    async delete(path){
        ...
        let userOrGuest = user.IsloggedIn()?'users' : 'guest'
        let id = user.IsloggedIn()?user.getUniqueId() : user.guestId
        await fetch(`http://54.90.104.210:2002/delete?userguest=${userOrGuest}&uniqueId=${id}&name=${path}`,{method:'GET'})
            .then(res=>res.json())
            .then((res)=>{r=res})
        return r;
    }
    async rename(src,des){
        ...
        let userOrGuest = user.IsloggedIn()?'users' : 'guest'
        let id = user.IsloggedIn()?user.getUniqueId() : user.guestId
        await fetch(`http://54.90.104.210:2002/rename?userguest=${userOrGuest}&uniqueId=${id}&src=${src}&des=${des}`,{method:'GET'})
            .then(res=>res.json())
            .then((res)=>{r=res})
        return r;
    }
